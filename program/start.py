        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🔮𝐒𝐎𝐔𝐑𝐂𝐄 𝐕𝘼𝙈𝘽𝙄𝙍🔮", url=f"https://t.me/{UPDATES_CHANNEL}"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("قــنــاة الــسورس🌀", url=f"https://t.me/{UPDATES_CHANNEL}"),
                    InlineKeyboardButton("جــروب الــدعم🎙", url=f"https://t.me/{GROUP_SUPPORT}"),
                ),
            ]
        ]
    )
