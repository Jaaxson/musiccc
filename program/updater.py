...
@Client.on_message(command(["update", "حديث البوت", f"update@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
...
@Client.on_message(command(["restart","عاده تشغيل", f"restart@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
