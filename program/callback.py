...
⚡ __قناة البوت»  @{UPDATES_CHANNEL}  A.I__""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("🎮الاوامــر الكامله المعربــه🎮", callback_data="cbegypt")                    
                ],[
                    InlineKeyboardButton("🔙 رجوع", callback_data="cbstart")
                ],
            ]
...
@Client.on_callback_query(filters.regex("cbegypt"))
async def cbbasic(_, query: CallbackQuery):
    await query.edit_message_text(
